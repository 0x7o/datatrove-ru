...
CITATION_REGEX = re.compile(r"\[\d*]|\[править]|\[источник]")
END_PUNCTUATION = (".", "?", "!", '"', "'")
ELLIPSIS = "..."
POLICY_SUBSTRINGS = [
...
if __name__ == "__main__":
    # Test C4QualityFilter
    c4_quality_filter = C4QualityFilter(language=Languages.russian)
    doc = Document(
    ...
    print(c4_quality_filter.filter(doc))
